...
<div class="nav">
    ...
    <div class="banner">
        <img src="includes/images.php?id=8">
    </div>
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                session_start();
                    ...
                    $sql= "SELECT * FROM seas";

                    $result = mysqli_query($conn,$sql);
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<figure class="figure">';
                        echo '<img src="includes/Seas.php?id=' . $row['ID'] . '"';
                        ...
                        echo ' <a type="button" class="btn btn-outline-info" href="Restaurants.php?DistrictID='.$row['ID'].'">Restaurants</button>';
